      ...
      <div class="game-wrapper">
        <div class="game-control">
          ...
          <div class="game-status row">
            <div v-for="style in styleBall" :key="style.left">
              <div class="ball" v-bind:style="{left:style.left+'px'}"></div>
            </div>
          </div>
        </div>
        ...
        <font-awesome-icon class="arrow-down" icon="arrow-down" />
      </div>
    </div>
  </section>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      image: {
        backgroundImage:
          "url(https://c8.alamy.com/comp/T9DNRE/artificial-intelligence-ai-and-machine-learning-technology-website-banner-or-background-T9DNRE.jpg)"
      }
    };
  }
  //   methods: {
...
.flag {
  background-image: url(https://content.dragonlearn.in/128633/1131/23.png);
  top: 325px;
  position: absolute;
  right: 380px;
  width: 140px;
...
.flagstaff {
  ...
  position: absolute;
  right: 380px;
  background-image: url(https://content.dragonlearn.in/128633/1131/35.png);
  width: 220px;
  height: 540px;
}
h2 {
